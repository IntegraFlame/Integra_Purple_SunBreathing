...
â”œâ”€â”€ plugins/
â”‚   â””â”€â”€ <plugin_name>/
â”‚       â”œâ”€â”€ plugin.json         # Required marker file
â”‚       â”œâ”€â”€ mcp_config.json     # Optional MCP server definitions
â”‚       â”œâ”€â”€ hooks.json          # Optional event hooks definition
â”‚       â”œâ”€â”€ skills/             # Optional skills
â”‚       â”œâ”€â”€ agents/             # Optional subagents
â”‚       â””â”€â”€ rules/              # Optional rules
â””â”€â”€ import_manifest.json        # Tracking manifest
```
...
Selecting a subagent from the panel opens a full-screen detail view. This view shows the entirety of the subagentâ€™s conversation, including its steps, thoughts, and tool execution logs.
...
**Tip**: Use the keyboard shortcut `ctrl+j` to â€œteleportâ€ from the main conversation directly to the detailed view of the next subagent waiting for your approval.
